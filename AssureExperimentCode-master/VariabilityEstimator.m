...
% %                 LineDisplay.displayVariabilityWithoutSeg(currentIm, bw_1);
%                 
...
%             end
            ...
            for z = find(sum(sum(seg,1),2) > 0)'
                ...
                % apply active contour, and save every iterations result
                out_mask = currentSeg;
                in_mask = currentSeg;
                for iter = 1:OptionsIn.Iterations
                    current_mask = activecontour(currentIm, currentSeg, iter);
