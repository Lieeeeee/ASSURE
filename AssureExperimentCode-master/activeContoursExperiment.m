...
% experiment_folder = '/cs/casmip/clara.herscu/git/thesis/figs/activeContour_dec17/experiment_111217/different_init/';
% allResStruct = struct;
% 
...
% end
% 
% save('AssureExperimentCode-master/activeContourDifferentInitializationsExperiment111217.mat')

%% debugging weird looking active contour results
experiment_folder = '/cs/casmip/clara.herscu/git/thesis/figs/activeContour_dec17/experiment_111217/debug_different_init/';
segNum = 5;
[resLiver, outMasksLiver] = VariabilityExperiment.holdExperiment(liverImgCell3D,kernelSize,[],[experiment_folder 'liver/' num2str(segNum) '/'],Tlength,0,1,segNum);
%     printRes(resLiver)